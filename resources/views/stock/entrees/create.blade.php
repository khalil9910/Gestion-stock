<x-app-layout>
    <x-slot name="header">
        <div>
            <h5 class="mb-1">{{ __('Ajouter entree') }}</h5>
            ...
            <form method="POST" action="{{ route('stock.entrees.store') }}">
                ...
                <div class="row gx-3">
                    <div class="col-12 col-md-6">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="qte_entree" name="qte_entree" placeholder="Quantite" value="{{ old('qte_entree') }}" required>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="date_entree" name="date_entree" placeholder="Date" value="{{ old('date_entree') }}" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="num_bon_commande" name="num_bon_commande" placeholder="Numero bon commande" value="{{ old('num_bon_commande') }}" required>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a class="btn btn-link" href="{{ route('stock.entrees.index') }}">{{ __('Retour') }}</a>
                </div>
            </form>
        </div>
    </div>
