<x-app-layout>
    <x-slot name="header">
        <div>
            <h5 class="mb-1">{{ __('Ajouter sortie') }}</h5>
    ...
    <div class="card adminuiux-card mb-3 mb-lg-4">
        <div class="card-body">
            <form method="POST" action="{{ route('stock.sorties.store') }}">
                @csrf
                ...
                <div class="row gx-3">
                    <div class="col-12 col-md-6">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="qte_sortie" name="qte_sortie" placeholder="Quantite" value="{{ old('qte_sortie') }}" required>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="date_sortie" name="date_sortie" placeholder="Date" value="{{ old('date_sortie') }}" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="num_bl" name="num_bl" placeholder="Numero BL" value="{{ old('num_bl') }}" required>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a class="btn btn-link" href="{{ route('stock.sorties.index') }}">{{ __('Retour') }}</a>
                </div>
            </form>
        </div>
    </div>
