            ...
            <div class="row gx-3 align-items-center">
                ...
                <div class="col-auto">
                    <div class="d-flex gap-2 flex-wrap">
                        <a class="btn btn-outline-theme btn-sm" href="{{ route('admin.fournisseurs.archive') }}">
                    ...
                    <tbody>
                        @foreach ($fournisseurs as $fournisseur)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-link btn-sm" href="{{ route('admin.fournisseurs.show', $fournisseur) }}">
                                        <i class="bi bi-eye me-1"></i>{{ __('Voir') }}
                                    </a>
                                    <a class="btn btn-link btn-sm" href="{{ route('admin.fournisseurs.edit', $fournisseur) }}">
